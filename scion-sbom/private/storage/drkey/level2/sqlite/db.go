...
SELECT EpochBegin, EpochEnd, Key, IsQKD
...
func (e *executor) GetASHostKey(
	...
	).Scan(&epochBegin, &epochEnd, &bytes, &isQkd)
	if err != nil {
...
DstHostIP, EpochBegin, EpochEnd, Key, IsQKD)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`
...
SrcHostIP, EpochBegin, EpochEnd, Key, IsQKD)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`
...
SrcHostIP, DstHostIP, EpochBegin, EpochEnd, Key, IsQKD)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`
