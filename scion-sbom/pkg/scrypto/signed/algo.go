...
func signatureAlgorithmFromPB(a pbcrypto.SignatureAlgorithm) SignatureAlgorithm {
	...
	case pbcrypto.SignatureAlgorithm_SIGNATURE_ALGORITHM_MLDSA44:
		return MLDSA44
	default:
...
func (a SignatureAlgorithm) toPB() pbcrypto.SignatureAlgorithm {
	...
	case MLDSA44:
		return pbcrypto.SignatureAlgorithm_SIGNATURE_ALGORITHM_MLDSA44
	default:
...
var signatureAlgorithmDetails = map[SignatureAlgorithm]struct {
	...
	MLDSA44: {name: "MLDSA44", pubKeyAlgo: pkMLDSA44},
}
